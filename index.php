...
<html lang="en">
  ...
  <body onload="doCookie()">
    ...
    <div class="newsletter">
      <h2>Vous êtes interessé par notre site ?</h2>
      <h3>Abonnez-vous à nos newsletter pour être au courant des futurs versions de notre simulateur</h3>
      <h4>Promis pas de spam</h4>
      <form action="saveTo.php" method="post">

        <input type="email" name="mail" placeholder="Ton adresse mail">
        <input type="submit" name="btn" value="S'abonner aux newsletter">
      </form>

    </div>
    <script src="script.js"></script>
    <script src="cookie_counter.js"></script>
